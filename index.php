<?php
  ...
  if(isset($_POST['register'])){
    include('includes/connection.php');
    $query = "insert into users values(null,'$_POST[fname]','$_POST[lname]','$_POST[email]','$_POST[password]',$_POST[mobile],'$_POST[address]')";
    $query_run = mysqli_query($connection,$query);
    if($query_run){
      echo "<script type='text/javascript'>
...
<body>
    <div id="header">
        <h1 id="h1" align="center">Mess Management System</h1>
        <button class="btn btn-success" type="button" data-toggle="modal" data-target="#login_modal" name="login" id="login_button">Login</button>
        <button class="btn btn-warning" type="button"  data-toggle="modal" data-target="#admin_login_modal" name="admin_login" id="admin_login_button">Admin Login</button>
        <button class="btn btn-danger" type="button" data-toggle="modal" data-target="#register_modal" name="register" id="register_button">Register</button><br>
